...
commons/os/%.o commons/os/%.su: ../commons/os/%.c commons/os/subdir.mk
...
clean: clean-commons-2f-os

clean-commons-2f-os:
	-$(RM) ./commons/os/os.d ./commons/os/os.o ./commons/os/os.su

.PHONY: clean-commons-2f-os
